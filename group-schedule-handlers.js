...
const TIME_RE = /^(0?[1-9]|1[0-2]):([0-5][0-9])$/; // 12-hour clock, no AM/PM (matches, e.g., "2:34" or "02:34")
...
// Combined "IDP - Start" time-pair regex, e.g. "12:54 - 1:00" or "02:54 - 01:00"
const TIME_PAIR_RE = /^(0?[1-9]|1[0-2]):([0-5][0-9])\s*-\s*(0?[1-9]|1[0-2]):([0-5][0-9])$/;
